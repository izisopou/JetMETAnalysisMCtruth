...
const char eta_boundaries_coarse[NETA_Coarse+1][10] = {"-5","-3","-2.7","-2.4","-1.3","0","1.3","2.4","2.7","3","5"};
...
const double veta_coarse[NETA_Coarse+1] = {-5.0,-3.0,-2.7,-2.4,-1.3,0,1.3,2.4,2.7,3,5};
...
const TString detector_names[NDetectorNames] = {"Barrel","Inner Endcap","Outer Endcap 1", "Outer Endcap 2","Forward"};

const TString detector_regions_eta[NDetectorNames] = {"|#eta| < 1.3","1.3 < |#eta| < 2.4","2.4 < |#eta| < 2.7","2.7 < |#eta| < 3.0","3.0 < |#eta| < 5.0"};

const TString detector_regions[NDetectorRegions] = {"Barrel","Endcap","Forward"};

const int closureColors[NDetectorNames] = {kBlack, kBlue, kRed, kOrange, kMagenta};

const int closureShapes[NDetectorNames] = {kFullCircle, kOpenCircle, kFullSquare, kFullTriangleUp, kOpenTriangleUp};

const int colDet[NDetectorNames] = {kGreen+3,kBlue+1,kYellow+2,kMagenta,kRed+1};
...
const double XminCalo[NDetectorNames] = {30.0,30.0,30.0,30.0,30.0};

//const double XminPF[NDetectorNames] = {6,6,6,6};
const double XminPF[NDetectorNames] = {10.0,10.0,10.0,10.0,10.0};

const double Xmax[NDetectorNames] = {5000,3000,2000,2000,190};
