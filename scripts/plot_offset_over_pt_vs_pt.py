...
class L1OffsetVsPt():
    def __init__(self, radius, algo, prefix):
        ...
        self.filename = 'Offset'+prefix+'L1SemiSimpleSmallerRangesOverPtVsPt_AK'+self.radius+self.algo+'_default'
    ...
    def Plot(self):
        ...
        for year in self.years:
            ...
            for eta in self.etabins:
                ...
                #if eta=='BB':   
                #    TDR.extraText3.append('-1.479 < #eta < 0.087')
                #    TDR.extraText3.append('-1.22 < #phi < -0.78')
                ...
                if 'Before' in self.filename:
                    ...
                    if eta=='1EO' or eta=='2EO': PlotYMax = 240
